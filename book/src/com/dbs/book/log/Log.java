...
public class Log {
     ...
     * @param context
     */
    public static void setLogConfiguration(Context context){
//        if(context == null) return ;
//        Resources resources = context.getResources();
//        if(resources.getBoolean(R.bool.log_record_exception)){
//            CrashHandler.init();
//        }
//        boolean log_isEnable = resources.getBoolean(R.bool.log_isEnable);
//        Log.setEnabled(log_isEnable);
//        if(!log_isEnable){
//            android.util.Log.w(TAG, "log_isEnable is :" + log_isEnable);
//            return ;
//        }
//        Log.setTag(resources.getString(R.string.app_name));
//        if(!resources.getBoolean(R.bool.log_write_sd)) return ;
//        String rootpath = CommonUtils.getSdCacheRootPath(context);
//        if(rootpath == null) return ;
//        Log.setPath(rootpath + resources.getString(R.string.log_dir),"log","txt");
//        Log.setPolicy(resources.getInteger(R.integer.log_policy));
//        Log.d("SD Debug log set success");
    }
