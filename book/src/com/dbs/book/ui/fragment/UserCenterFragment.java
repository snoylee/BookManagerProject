...
public class UserCenterFragment extends Fragment implements OnClickListener{
		 ...
		 public void handleMessage(android.os.Message msg) {
			 if(msg.arg1 == 01){
				 ...
				 if(bitmap != null){
					 ...
					 editor.putString("userNameImage",bitmaptoString(bitmap));
					 editor.commit();
				 }else{
					 return;
				 }
	...
	protected void onSuccess(String string) {
		...
		if(centerUserInfos.getString("clazz").equals("0")){
			if(centerUserInfos.getString("grade") == null){
				fragmentCenterGradeClass.setText(" ");
			}else{
				fragmentCenterGradeClass.setText(centerUserInfos.getString("grade")+"  ");
			}
		}else{
			fragmentCenterGradeClass.setText(centerUserInfos.getString("clazz")+"班级 ");
		}
		...
		if(userNameImage.equals("")){
			new Thread(new  Runnable() {
			 ...
			 this.userNameImage.setImageBitmap(PictureUtil.getRoundedCornerBitmap(stringtoBitmap(userNameImage),ROUNDPX));
		}
	}
