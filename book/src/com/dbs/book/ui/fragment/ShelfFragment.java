...
public class ShelfFragment extends Fragment implements View.OnClickListener{
	...
	protected void downloadAndRead(final BookInfo bookInfo) {
		...
		FileDownloader.DownloadController controller = ProjectApp.mFileDownloader.add(file.getAbsolutePath() + "/" 
		+ bookInfo.getName() + ".txt", bookInfo.getTxtUrl(), new Listener<Void>() {
			@Override
	...
	private void findView(View root) {
		mBookList_LV = (SwipeMenuListView) root.findViewById(R.id.listView);
